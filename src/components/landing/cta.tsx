        ...
        <div className="relative isolate overflow-hidden bg-gradient-to-r from-[#50B4F2] to-[#7950F2] shadow-2xl rounded-2xl px-6 py-20 text-center">
           <div className="absolute inset-0 z-0">
             <div className="background-animation">
                <div className="circle-1" style={{ animationDuration: '20s', opacity: 0.1 }}></div>
                <div className="circle-2" style={{ animationDuration: '25s', opacity: 0.15 }}></div>
                <div className="circle-3" style={{ animationDuration: '30s', opacity: 0.1 }}></div>
             </div>
           </div>
